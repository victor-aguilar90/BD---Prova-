...
select Titulo.nome_cd, Gravadora.nome_grav from Titulo 
inner join Gravadora on Titulo.cod_grav = Gravadora.cod_grav;

select Titulo.nome_cd, Categoria.nome_cat from Titulo 
inner join Categoria on Titulo.cod_cat = Categoria.cod_cat;

select Titulo.nome_cd, Gravadora.nome_grav, Categoria.nome_cat from Titulo inner join 
Gravadora on Titulo.cod_grav = Gravadora.cod_grav inner join 
Categoria on Titulo.cod_cat = Categoria.cod_cat;

select Cliente.nome_cli, Titulo.nome_cd from Titulo inner join 
Titulo_Pedido on Titulo.cod_tit = Titulo_Pedido.cod_tit inner join 
Pedido on Titulo_Pedido.cod_ped = Pedido.cod_ped inner join 
Cliente on Pedido.cod_cli = Cliente.cod_cli;

select Funcionario.nome_func, Pedido.cod_ped, Pedido.data_ped,  Pedido.data_ped, 
Pedido.val_ped, Cliente.nome_cli from  Funcionario inner join
Pedido on  Funcionario.cod_func = Pedido.cod_func inner join  
Cliente on Cliente.cod_cli = Pedido.cod_cli;
